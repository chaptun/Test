...
local win = ui:W1n("Edog Hub","",0.30,Enum.KeyCode.RightControl)
...
AutoFarm:Title("Title")
AutoFarm:Label("Label")


AutoFarm:ToggleDesc("FastAttack","Toggle",false,function(vu)
    _G.FastAttack = vu
end)
spawn(function()
    game:GetService("RunService").RenderStepped:Connect(function()
...
_G.TpSpeede = 50
AutoFarm:Slider(" Slider",true,0,100,_G.TpSpeede,10,function(v)
	_G.TpSpeed = v
end)
